    ...
    public class Q_62 {
    // In interface we can create abstract method in two ways
    // 1) with abstract keyword. 2) without abstract keyword
    // when a class implements an abstract class,
    // methods need to be initialized.
    }
    ...
    interface Readable extends Downloadable {   //line n1
        ...
        //downloadi var sen implement etmesen de ediyor
    }
    ...
    // classin icine interface'deki tüm methodlari implement etmek zorundasin
