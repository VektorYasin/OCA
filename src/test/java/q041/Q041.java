...
// 		3 Result E 34
	...
	// when the first statement is String, the following int values
	// will be concatenated as String
	// when the first statement is String, the following equation
	// in parentheses will be considered as int
